...
HD_PWD='C:/Users/HP/perceptron_behavioral/perceptron_behavioral/perceptron_behavioral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log perceptron_dataset.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source perceptron_dataset.tcl
