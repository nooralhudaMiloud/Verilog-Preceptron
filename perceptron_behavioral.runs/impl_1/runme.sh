...
HD_PWD='C:/Users/HP/perceptron_behavioral/perceptron_behavioral/perceptron_behavioral.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log perceptron_dataset.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source perceptron_dataset.tcl -notrace
